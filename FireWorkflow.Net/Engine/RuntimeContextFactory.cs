			...
			if (ctx == null)
			{
				...
				switch (dbtype)
				{
					...
					case "oracle":
						...
						break;
					case "sqlite":
						type = Type.GetType("FireWorkflow.Net.Persistence.SQLiteDAL.PersistenceServiceDAL, FireWorkflow.Net.Persistence.SQLiteDAL");
						break;
					default:
				...
				if (type != null)
				{
					...
					switch (dbtype)
					{
						...
						case "oracle":
							...
							break;
						case "sqlite":
							ctx.PersistenceService = (IPersistenceService)Activator.CreateInstance(type, new object[] { "Sqlite" });
							break;
						default:
