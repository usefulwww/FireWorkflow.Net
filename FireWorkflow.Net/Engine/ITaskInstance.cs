...
namespace FireWorkflow.Net.Engine
{
    ...
    /// </summary>
    public interface ITaskInstance :  IWorkflowSessionAware
    {
...
//        IProcessInstance AliveProcessInstance { get;  }
        ...
        Boolean CanBeWithdrawn { get; set; }
...
//        Task Task { get;  }// throws EngineException;
        ...
        String TargetActivityId { get;set;  }
