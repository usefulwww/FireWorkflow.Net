<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InstancesDataViewerBean.aspx.cs"
    Inherits="WebDemo.Example.WorkflowExtension.InstancesDataViewerBean" %>
...
<body>
    ...
    <ext:Viewport ID="ViewPort1" runat="server" HideBorders="true" Layout="BorderLayout">
        <Items>
            <ext:GridPanel ID="mpgList" runat="server" StoreID="Sdate" ClicksToEdit="1" StripeRows="true"  AutoExpandColumn="DisplayName" Title="流程实例" Region="Center">
            ...
            <ext:Panel ID="Panel1" runat="server" Height="200" Title="流程信息" Region="South" HideBorders="true">
                <Items>
                    <ext:TabPanel ID="TabPanel1" runat="server" ActiveTabIndex="0"  TabPosition="Bottom">
                        <Items>
                            <ext:Panel ID="Tab1" runat="server" Title="Task实例" HideBorders="true">
                                <Items>
                                    <ext:GridPanel ID="GridPanel1" runat="server" Layout="FitLayout" StoreID="Store1" ClicksToEdit="1" StripeRows="true" AutoExpandColumn="BizInfo" Collapsible="true">
                            ...
                            <ext:Panel ID="Tab2" runat="server" Title="流程变量" HideBorders="true">
                                <Items>
    ...
    <ext:Window ID="WindowView" runat="server" Width="650" Height="450" Collapsible="True"
        Maximizable="true" Constrain="True" Hidden="true" Icon="Help" Title="流程" BodyStyle="padding: 5px;"
        Modal="True">
