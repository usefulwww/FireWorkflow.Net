<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RejectInfo.aspx.cs" Inherits="WebDemo.Example.LoanProcess.RejectInfo" %>
        ...
        <Items>
            <ext:FormLayout ID="FormLayout1" runat="server" LabelWidth="120">
                <Anchors>
                    ...
                    <ext:Anchor Horizontal="100%">
                        <ext:Label ID="rejectInfoInputTime" runat="server" FieldLabel="拒绝贷款信息录入时间人" />
                    </ext:Anchor>
                    <ext:Anchor Horizontal="100%">
                        <ext:TextArea ID="comments" runat="server" FieldLabel="拒绝贷款备注" />
                    </ext:Anchor>
                </Anchors>
            </ext:FormLayout>
        </Items>
