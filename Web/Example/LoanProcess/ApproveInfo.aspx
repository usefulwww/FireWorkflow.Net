<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveInfo.aspx.cs" Inherits="WebDemo.Example.LoanProcess.ApproveInfo" %>
        ...
        <Body>
            <ext:FormLayout ID="FormLayout1" runat="server" LabelWidth="120">
                <Anchors>
                    ...
                    <ext:Anchor Horizontal="100%">
                        <ext:ComboBox ID="my_decision" runat="server" ReadOnly="false" FieldLabel="审批决定">
                            <Items>
                                <ext:ListItem Text="同意" Value="True" />
                                <ext:ListItem Text="不同意" Value="False" />
                            </Items>
                            <SelectedItem Value="True" />
                        </ext:ComboBox>
                    </ext:Anchor>
                    <ext:Anchor Horizontal="100%">
                        <ext:TextArea ID="comments" runat="server" FieldLabel="详细意见" />
                    </ext:Anchor>
                </Anchors>
            </ext:FormLayout>
        </Body>
