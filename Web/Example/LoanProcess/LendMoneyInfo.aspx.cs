...
{
    public partial class LendMoneyInfo : System.Web.UI.Page
    {
            ...
            if (!this.IsPostBack)
            {
                if (this.Request.QueryString["WorkItemId"] != null)
                {
                    ...
                    if (ti != null)
                    {
                        ...
                        lendMoneyOfficer.Text = this.User.Identity.Name;
                        lendMoneyInfoInputTime.Text = DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss");
                    }
                }
            }
        }
        ...
        public void Save_Click(object sender, AjaxEventArgs e)
        {
            ...
            loanInfo.LendMoneyInfoInputTime = DateTime.Parse(lendMoneyInfoInputTime.Text);//lendMoneyInfo
            loanInfo.LendMoneyInfo = comments.Text;
